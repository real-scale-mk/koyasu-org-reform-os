...
export function Workspace({ seed }: WorkspaceProps) {
  ...
  const updatePane3Step2Role = useCallback(
    (roleId: Pane3Step2RoleId, patch: Partial<Pane3Step2RoleFields>) => {
      setPane3Step2((prev) => {
        const nextRoles = {
          ...prev.roles,
          [roleId]: {
        ...
        return {
          roles: nextRoles,
          entries: prev.entries.map((entry, currentIndex) =>
            currentIndex === 0 ? { roles: nextRoles } : entry,
          ),
        };
      });
    },
  ...
  const updatePane3Step3Field = useCallback(
    (fieldId: Pane3Step3FieldId, patch: Partial<Pane3Step3Field>) => {
      setPane3Step3((prev) => ({
        ...prev,
        [fieldId]: {
          ...prev[fieldId],
  ...
  const updatePane3Step3Backing = useCallback(
    (patch: Partial<Pane3Step3Backing>) => {
      setPane3Step3((prev) => ({
        ...prev,
        backing: {
          ...prev.backing,
      ...
      <SidebarInset className="flex min-w-0 flex-col bg-background">
        ...
        <div className="flex min-h-0 flex-1">
          ...
          <ReformStrategyDesignPane
            ...
            onUpdatePane3Step2Role={updatePane3Step2Role}
            onUpdatePane3Step3Field={updatePane3Step3Field}
            onUpdatePane3Step3Backing={updatePane3Step3Backing}
          />
